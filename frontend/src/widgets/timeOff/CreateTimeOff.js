      ...
      <form noValidate autoComplete="off">
        ...
        <div>
          <Select
            ...
            {reason.map(r => <MenuItem value={r}>{r}</MenuItem>)}
          </Select>
        </div>
        <div>
          <TextField
        ...
        <div className={style.dateContainer}>
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
            <DatePicker
              ...
              onChange={date => setCreateData({...createData, startDate: format(date, ISO_FORMAT)})}
            />
          ...
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
            <DatePicker
              ...
              onChange={date => setCreateData({...createData, endDate: format(date, ISO_FORMAT)})}
            />
          </MuiPickersUtilsProvider>
        </div>
